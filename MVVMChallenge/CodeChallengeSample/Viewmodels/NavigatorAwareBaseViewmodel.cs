...
namespace Core.Viewmodels
{
    ...
    /// Store Apps. If you don't need to include back buttons in your App (e.g., if you only target Windows Phone platforms),
    ...
    public class NavigatorAwareBaseViewmodel : BaseViewmodel
    {
        ...
        /// </summary>
        public BaseCommand GoBackCommand { get; set; }
